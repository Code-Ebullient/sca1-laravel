				...
				<div class=" rsidebar span_1_of_left">
						<h4 class="cate">Categories</h4>
							...
							<li class="item1"><a href="#">Men </a>
								<ul class="cute">
									<li class="subitem1"><a href="product.blade.php">Cute Kittens </a></li>
									<li class="subitem2"><a href="product.blade.php">Strange Stuff </a></li>
									<li class="subitem3"><a href="product.blade.php">Automatic Fails </a></li>
								</ul>
							</li>
